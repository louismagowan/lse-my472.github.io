...
```{r}
authentication <- list(consumer_key = "6lg7sR2q9QuUbEs0oC1JCFp2V",
                 consumer_secret = "ALSzbmjg61XpAFp2GfItF1bvTdYA03ulpjsgtdHbX7FgVKMdny",
                 access_token = "627360390-fD5HT41d5BdZAWjjIOT2tVTTYDmPNjM46cqxhSOP",
                 access_token_secret = "smlS253omv60IkD8tTxjg6qA4kX3abKYZ5ufoGPJ8XEgT")
```
...
lookup_users("louismagowan")$screen_name
```
...
```{r}
keywords_tweets <- stream_tweets(q = "trump AND biden", timeout = 5)
...
```{r}
# stream_tweets(q = c(-83.07413807822492, 42.3721877949165, -83.07840815489244, 42.36865257592395), timeout = 30, file_name='detroit.json')
...
# Map base
p <- ggplot(map.data) + geom_map(aes(map_id = region), map = map.data, fill = "grey90", 
